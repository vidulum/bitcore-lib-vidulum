...
```
vidulum:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu
vidulum:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2
vidulum:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2&message=Payment&label=Satoshi&extra=other-param
```
...
```javascript
var uriString = 'vidulum:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2';
